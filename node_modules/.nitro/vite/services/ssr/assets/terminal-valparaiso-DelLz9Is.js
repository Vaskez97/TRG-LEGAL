import { l as VALPARAISO_IMAGE } from "./Navigation-GK06mQP5.js";
import { o as PageShell } from "./PageHero-CYPI-FKy.js";
import { t as TerminalTemplate } from "./TerminalTemplate-ir5efpG6.js";
import { jsx } from "react/jsx-runtime";
//#region src/routes/terminal/terminal-valparaiso.tsx?tsr-split=component
function Page() {
	return /* @__PURE__ */ jsx(PageShell, { children: /* @__PURE__ */ jsx(TerminalTemplate, {
		name: "Valparaíso",
		...
		capabilities: [
			{
				title: "Patio adocretado",
				detail: "De 25.000 m² para contenedores."
			},
			{
				title: "6.000 m² de bodegas",
				detail: "Para carga general."
			},
			{
			...
			{
				title: "Zona de conexión",
				detail: "Para contenedores refrigerados (reefers)."
			},
			{
				title: "Operación preparada",
				detail: "Para altos volúmenes de carga."
			}
		],
		infrastructure: [
